    ...
    return BlocBuilder<MovieDetailBloc, MovieDetailState>(
      builder: (context, state) {
        ...
        if (state is MovieDetailLoaded) {
          ...
          // Puedes manejar otros estados del Bloc aquí (cargando, error, etc.)
        }
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        //mostramos la fecha de lanzamiento
        Padding(
          padding: const EdgeInsets.all(8),
          child: Text(
            //que el formato de la fecha sea dd/MM/yyyy
